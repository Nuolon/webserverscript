...
sed -i 's#$CFG->wwwroot   = '\''http://example.com/moodle'\'';#$CFG->wwwroot   = '\''http://10.15.1.12'\'';#' /var/www/moodle/config.php
...
echo -e "${CYAN}^_^ Script completed, Moodle is reachable on: 10.15.1.12 ^_^${NC}${NRML}"
}
